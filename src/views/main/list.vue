    ...
    <div class="list-detail" ref="wrapper">
      <div class="desc" v-if="+list_id">
        ...
        <div class="info">
          ...
          <div class="author">
            <img
              v-lazy='desc.creator ? desc.creator.avatarUrl : require("@/assets/images/default-headimg.png")'
              width="30"
            />
            <a href="javascript:;">
      ...
      <div class="list-table" v-if="tab == 0">
        ...
        >
            ...
            <el-table-column label="音乐标题" min-width="120px">
                <p
                slot-scope="scope"
                class="text-ellipses flex primary"
            ...
            <el-table-column label="专辑" min-width="100px">
              <template slot-scope="scope">
                <router-link tag="a" :to="{name:'album',params:{id:scope.row.al.id||scope.row.album.id}}"  class="text-ellipses">
...
export default {
    ...
    methods: {
      ...mapMutations(['changeLikeList','changeSubAlbum','changeSubList']),
        getInfo() {
          if(+this.list_id){
            axios.post("/playlist/detail", {
                id: this.list_id,
                })
                .then((res) => {
                console.log(res);
    ...
    computed: {
        ...mapState(["audioInfo",'likeList','subAlbum','uid','subList']),
    },
